...
/******/ 	var hotCurrentHash = "4aebf92db3cdd90e2e73"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mountNode = document.getElementById('js-root');
	if (mountNode) {
	  ...
	  (0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(_Root2.default, { id: '1' })
	  ), mountNode);
	}
	...
	var Root = function (_React$Component) {
	  ...
	  _createClass(Root, [{
	    ...
	    value: function render() {
	      ...
	      var str = id + " button Count on " + this.state.count;
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(
	          "button",
	          { type: "button", className: "btn btn-primary", onClick: this.count.bind(this) },
	          str
	        )
	      );
	    }
